...
describe('v1beta.AgentEndpointServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      agentendpointserviceModule.v1beta.AgentEndpointServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      agentendpointserviceModule.v1beta.AgentEndpointServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port =
      agentendpointserviceModule.v1beta.AgentEndpointServiceClient.port;
    assert(port);
    ...
    it('invokes startNextTask without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.startNextTask(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.osconfig.agentendpoint.v1beta.IStartNextTaskResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes reportTaskProgress without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.reportTaskProgress(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.osconfig.agentendpoint.v1beta.IReportTaskProgressResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes reportTaskComplete without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.reportTaskComplete(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.osconfig.agentendpoint.v1beta.IReportTaskCompleteResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes lookupEffectiveGuestPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.lookupEffectiveGuestPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.osconfig.agentendpoint.v1beta.IEffectiveGuestPolicy | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes registerAgent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.registerAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.osconfig.agentendpoint.v1beta.IRegisterAgentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes receiveTaskNotification without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.osconfig.agentendpoint.v1beta.ReceiveTaskNotificationResponse
          ) => {
            resolve(response);
          }
        );
