...
describe('v1.OsConfigZonalServiceClient', () => {
    ...
    describe('getOSPolicyAssignment', () => {
        it('invokes getOSPolicyAssignment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.osconfig.v1.GetOSPolicyAssignmentRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.osconfig.v1.OSPolicyAssignment());
    ...
    describe('getOSPolicyAssignmentReport', () => {
        it('invokes getOSPolicyAssignmentReport without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.osconfig.v1.OSPolicyAssignmentReport());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getOSPolicyAssignmentReport as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getInventory', () => {
        it('invokes getInventory without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.osconfig.v1.GetInventoryRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.osconfig.v1.Inventory());
    ...
    describe('getVulnerabilityReport', () => {
        it('invokes getVulnerabilityReport without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.osconfig.v1.VulnerabilityReport());
    ...
    describe('updateOSPolicyAssignment', () => {
        it('invokes updateOSPolicyAssignment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.osconfig.v1.UpdateOSPolicyAssignmentRequest());
    ...
    describe('listOSPolicyAssignments', () => {
        it('invokes listOSPolicyAssignments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.osconfig.v1.ListOSPolicyAssignmentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listOSPolicyAssignmentRevisions', () => {
        it('invokes listOSPolicyAssignmentRevisions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.osconfig.v1.ListOSPolicyAssignmentRevisionsRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listOSPolicyAssignmentReports', () => {
        it('invokes listOSPolicyAssignmentReports without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listOSPolicyAssignmentReports as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listInventories', () => {
        it('invokes listInventories without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.osconfig.v1.ListInventoriesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listVulnerabilityReports', () => {
        it('invokes listVulnerabilityReports without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.osconfig.v1.ListVulnerabilityReportsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
