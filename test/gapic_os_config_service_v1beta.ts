...
describe('v1beta.OsConfigServiceClient', () => {
  ...
  describe('createGuestPolicy', () => {
    ...
    it('invokes createGuestPolicy without error using callback', async () => {
      ...
      client.innerApiCalls.createGuestPolicy = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('getGuestPolicy', () => {
    ...
    it('invokes getGuestPolicy without error using callback', async () => {
      ...
      client.innerApiCalls.getGuestPolicy = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateGuestPolicy', () => {
    ...
    it('invokes updateGuestPolicy without error using callback', async () => {
      ...
      client.innerApiCalls.updateGuestPolicy = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deleteGuestPolicy', () => {
    ...
    it('invokes deleteGuestPolicy without error using callback', async () => {
      ...
      client.innerApiCalls.deleteGuestPolicy = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('lookupEffectiveGuestPolicy', () => {
    ...
    it('invokes lookupEffectiveGuestPolicy without error using callback', async () => {
      ...
      client.innerApiCalls.lookupEffectiveGuestPolicy = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listGuestPolicies', () => {
    ...
    it('invokes listGuestPolicies without error using callback', async () => {
      ...
      client.innerApiCalls.listGuestPolicies = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listGuestPoliciesStream without error', async () => {
      ...
      client.descriptors.page.listGuestPolicies.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.listGuestPolicies
          .createStream as SinonStub).getCall(0).args[2].otherArgs.headers[
          'x-goog-request-params'
        ],
        expectedHeaderRequestParams
    ...
    it('uses async iteration with listGuestPolicies without error', async () => {
      ...
      client.descriptors.page.listGuestPolicies.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
